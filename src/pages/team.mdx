...
Der Team-Endpunkt liefert dir alle Informationen eine Manntschaft, die du auf Fussball.de unter "MAnnschaften des Vereins" sehen kannst.  {{ className: 'lead' }}

## Team-model

Das Team-Modell bietet dir detailliertere Informationen über Spieler
